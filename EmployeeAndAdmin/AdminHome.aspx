<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="EmployeeAndAdmin.AdminHome" %>
                                                    ...
                                                    <Series>
                                                        <asp:Series Name="Series1">
                                                            <Points>
                                                                ...
                                                                <asp:DataPoint AxisLabel="May" YValues="40" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Jun" YValues="30"/>
                                                                <asp:DataPoint AxisLabel="Jul" YValues="70" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Aug" YValues="40"/>
                                                                <asp:DataPoint AxisLabel="Sep" YValues="60" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Oct" YValues="90"/>
                                                                <asp:DataPoint AxisLabel="Nov" YValues="80" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Dec" YValues="40"/>
								...
								<div class="col-md-6 text-center">
									<div class="card">
										<div class="card-body">
                                            ...
                                            <div>
                                                <asp:Chart ID="ChartSalesOverview" runat="server">
                                                  <Titles><asp:Title Text="Sales Overview"></asp:Title></Titles>

                                                    <Series>
                                                        <asp:Series Name="Series1" ChartType="Spline" YValuesPerPoint="4">
                                                              <Points>
                                                                <asp:DataPoint AxisLabel="Jan" YValues="30,0,0,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Feb" YValues="40,0,0,0"/>
                                                                <asp:DataPoint AxisLabel="Mar" YValues="20,0,0,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Apr" YValues="10,0,0,0"/>
                                                                <asp:DataPoint AxisLabel="May" YValues="40,0,0,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Jun" YValues="30,0,0,0"/>
                                                                <asp:DataPoint AxisLabel="Jul" YValues="70,0,0,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Aug" YValues="40,0,0,0"/>
                                                                <asp:DataPoint AxisLabel="Sep" YValues="60,0,0,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Oct" YValues="90,0,0,0"/>
                                                                <asp:DataPoint AxisLabel="Nov" YValues="80,0,0,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Dec" YValues="40,0,0,0"/>

<%@ Page Title="" Language="C#" MasterPageFile="~/AdminView/Admins.Master" AutoEventWireup="true" CodeBehind="AdminViewEmployee.aspx.cs" Inherits="EmployeeAndAdmin.Admin.AdminViewEmployee" %>
         ...
         <!-- Page Wrapper -->
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <br />
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetDepartments" TypeName="EmployeeAndAdmin.EmployeeRepository"></asp:ObjectDataSource>

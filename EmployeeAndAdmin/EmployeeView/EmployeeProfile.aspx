<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeView/EmployeeMast.Master" AutoEventWireup="true" CodeBehind="EmployeeProfile.aspx.cs" Inherits="EmployeeAndAdmin.UserProfile" %>
    ...
    <form id="form1" runat="server">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <!--New Div For Employee data Spliting-->
                    <div class="row">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="ObjectDataSource1" ForeColor="#333333" GridLines="None" DataKeyNames="Emp_Id">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="Emp_Id" HeaderText="Emp_Id" SortExpression="Emp_Id" />
                                <asp:BoundField DataField="Emp_FirstName" HeaderText="Emp_FirstName" SortExpression="Emp_FirstName" />
                                <asp:BoundField DataField="Emp_LastName" HeaderText="Emp_LastName" SortExpression="Emp_LastName" />
                                ...
                                <asp:BoundField DataField="Emp_ContactNo" HeaderText="Emp_ContactNo" SortExpression="Emp_ContactNo" />
                            </Columns>
                        ...
                        <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="125px" AutoGenerateRows="False" CellPadding="4" DataSourceID="ObjectDataSource1" ForeColor="#333333" GridLines="None" CssClass="auto-style1" DefaultMode="Insert" OnItemInserted="DetailsView1_ItemInserted">
                            <AlternatingRowStyle BackColor="White" />
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="EmployeeAndAdmin.Employee_New_Tbl" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetEmployeesdata" TypeName="EmployeeAndAdmin.EmployeeRepository" UpdateMethod="UpdateEmployee"></asp:ObjectDataSource>
                    </div>

                    <!--End New Div For Employee data Spliting-->
